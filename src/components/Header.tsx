  ...
  return (
    <header className="bg-gray-900 w-full sticky top-0 fixed z-30 shadow-xl">
      <nav aria-label="Global"
        className="flex items-center p-5 lg:px-8 justify-between">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <a href="#home"
            className="text-md font-semibold leading-6 text-white hover:text-white/50"
