      ...
      <div className="mx-auto w-full">
        <div className="overflow-hidden p-10">
          <div className="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-200 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={googleDeveloper.src} width={300} height={300} alt="" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://drive.google.com/file/d/1PdrQ85nRX4rKz2aNAmgGOKwmdJ6V4gnU/view?usp=sharing")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <a className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100"
                href='https://alura.com.br' target="_blank">
                <h3 className="mb-3 font-bold text-gray-800 text-md">ROCKETSEAT</h3>
              </a>
              <div className="flex justify-center">
                <Image src={rocketseat.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://drive.google.com/file/d/1AizRN2CRhAffZ15TO4rtAq0SwEc7U94_/view?usp=drive_link")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={nodeJsCloud.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/e53c2522-2c5b-4d9f-9092-5ea9a9788b3d")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-200 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={figma.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/c4a9a254-991e-40fe-bd13-9e98912ce645")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <a className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100"
                href='https://vemprapuc.pucminas.br/desenvolvimento-full-stack' target="_blank">
                <h3 className="mb-3 font-bold text-gray-800 text-md">Puc-Minas</h3>
              </a>
              <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">
                No curso foram apresentado as principais metodologias, linguagens e
                ...
                <br></br>
                <br></br>
                <a onClick={() => setShowDetails({ ...showDetails, tccPosGraduacao: true })} target="_blank"
                  className="font-bold text-gray-800 text-opacity-100 cursor-pointer" > Clique aqui
                </a> para saber mais sobre o projeto
                {showDetails.tccPosGraduacao && <DetailsTCCPosGraduacao setShowDetails={setShowDetails} showDetails={{ tccPosGraduacao: true }} />}

              </p>
              <div className="flex justify-center">
                <Button title="Ver certificado" onClick={() => window.open("https://drive.google.com/file/d/1CkZKSaewgCweIvLwb_3eAPWR9TfmFnlD/view?usp=drive_link")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-200 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={scrum2.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/376b68dc-7dd8-4721-9d32-9ca58a42fd83")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={scrum1.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/aaf5a6bd-8a9f-4c12-890e-25df1f1eeb42")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-200 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={uxMonitore.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/537eab8d-6467-4c69-8fb5-879cb561bfdd")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={nodeJsApi.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/6a29dd17-152b-419d-a73a-f3cec2e90b23")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-200 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <div className="flex justify-center">
                <Image src={nodeJsCreate.src} width={300} height={300} alt="Alura" />
              </div>
              <div className="flex justify-center">
                <Button title="Ver Certificado" onClick={() => window.open("https://cursos.alura.com.br/certificate/82424ee8-0782-4e76-a5db-8ecb7903261c")} icon={'website'} />
              </div>
            </div>
          </div>
          ...
          <div className="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-full md:w-1/2 px-6 py-4 transition-transform hover:translate-y-[-20px] duration-500">
              ...
              <a className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100"
                href='https://escolha.ufop.br/cursos/engenharia-de-computacao' target="_blank">
              ...
              <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">
                ...
                <a className="font-bold text-gray-800 text-opacity-100" href='https://buscatextual.cnpq.br/buscatextual/visualizacv.do;jsessionid=84BE7FFD71992A4AED354A6E7F249501.buscatextual_0'
                  target="_blank"> Glauco Ferreira Gazel Yared</a> e
                <a className="font-bold text-gray-800 text-opacity-100" href='https://www.linkedin.com/in/gilda-aparecida-de-assis-507495/'
                  target="_blank"> Gilda Aparecida de Assis</a>
                <br></br>
                <br></br>
                <a href='https://www.monografias.ufop.br/handle/35400000/3501' target="_blank"
                  className="font-bold text-gray-800 text-opacity-100" > Clique aqui
