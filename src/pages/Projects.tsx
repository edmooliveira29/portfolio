    ...
    <section className='sm:px-0 pt-5 text-white'>
      ...
      <div className="lg:flex items-center my-5">
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
          <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${uaimobi.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                ...
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  ...
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, uaimobi: true })} />
                  {showDetails.uaimobi && <DetailsUaiMobi setShowDetails={setShowDetails} showDetails={{ uaiMobi: true }} />}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
          <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${nolascoModdas.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                <div className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500">
                  <h2 className="mb-4 text-2xl font-semibold">NOLASCO MODDAS</h2>
                  <div className="flex items-center justify-around">
                    <Image src={nuvemShopIcon} alt="Logo" className="h-10 w-auto" />
                  </div>
                </div>
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  <span className="text-md font-bold">ABRIL 2024</span>
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, nolascoModdas: true })} />
                  {showDetails.nolascoModdas && <DetailsNolascoModdas setShowDetails={setShowDetails} showDetails={{ nolascoModdas: true }} />}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
          <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${tccPosGraduacao.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                <div className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500">
                ...
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  ...
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, tccPosGraduacao: true })} />
      ...
      <div className="lg:flex items-center my-5 justify-center">
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
          <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${cachacaGestor.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                <div className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500">
                ...
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  ...
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, cachacaGestor: true })} />
                  {showDetails.cachacaGestor && <DetailsCachacaGestor setShowDetails={setShowDetails} showDetails={{ cachacaGestor: true }} />}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
          <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${farol.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                <div className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500">
                ...
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  ...
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, farol: true })} />
                  {showDetails.farol && <DetailsFarol setShowDetails={setShowDetails} showDetails={{ farol: true }} />}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
          <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${yattoLogo.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                <div className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500">
                ...
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  <span className="text-md font-bold">FREELANCER</span>
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, yatto: true })} />
                  {showDetails.yatto && <DetailsYatto setShowDetails={setShowDetails} showDetails={{ yatto: true }} />}
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="lg:flex items-center my-5 justify-center">
        <div className='w-full lg:w-1/3 h-full p-5 hover:scale-105 duration-500'>
        <div className="relative rounded-lg bg-cover p-12 text-center h-[250px] group" style={{ backgroundImage: `url(${portfolio.src})` }}>
            <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full rounded-lg bg-black/70 group-hover:bg-black/20 transition duration-500">
              <div className="flex h-full items-center justify-center">
                <div className="text-white opacity-100 group-hover:opacity-0 transition-opacity duration-500">
                ...
                <div className="w-full right-0 p-2 flex absolute bottom-0 items-center justify-between">
                  ...
                  <Button title={'VER MAIS'} onClick={() => setShowDetails({ ...showDetails, portfolio: true })} />
                  {showDetails.portfolio && <DetailsPortfolio setShowDetails={setShowDetails} showDetails={{ portfolio: true }} />}
                </div>
              </div>
            </div>
          </div>
