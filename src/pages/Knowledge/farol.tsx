...
import { SiEslint, SiJest, SiPrettier, SiStyledcomponents } from "react-icons/si"
...
type Props = {
  setShowDetails: Dispatch<React.SetStateAction<{farol: boolean}>>
  showDetails: {
    farol: boolean
  }
}
const DetailsFarol = ({ setShowDetails, showDetails }: Props) => {
  ...
  return (
    <Dialog open={open}
      onClose={() => { setOpen(false); setShowDetails({ ...showDetails, farol: false }) }}
            ...
            <div className="bg-gray-900">
              <div className="lg:flex text-white text-sm">
                <h1 className="text-2xl font-bold flex lg:hidden justify-between p-4 ">
                  FAROL
                  <CgClose size={25}
                    onClick={() => { setOpen(false); setShowDetails({ ...showDetails, farol: false }) }}/>
                </h1>
                ...
                <div className="w-full lg:w-1/2 p-5">
                  <h1 className="text-3xl font-bold hidden lg:flex my-2 justify-between">FAROL
                    <CgClose size={25}
                      onClick={() => { setOpen(false); setShowDetails({ ...showDetails, farol: false }) }}
                  ...
                  <p>Tive a oportunidade de trabalhar neste projeto durante <strong>5 meses</strong>, 
