...
const DetailsCachacaGestor = ({ setShowDetails, showDetails }: Props) => {
  ...
  return (
    <Dialog open={open} onClose={() => { setOpen(false); setShowDetails({ ...showDetails, cachacaGestor: false }) }} className="relative z-10 lg:w-[90%]">
      <DialogBackdrop
        transition
            ...
            <div className="bg-gray-900">
              <div className="lg:flex text-white text-sm">
                <h1 className="text-2xl font-bold flex lg:hidden justify-between p-4 ">
                  CACHAÇA GESTOR
                  <CgClose size={25} onClick={() => { setOpen(false); setShowDetails({ ...showDetails, cachacaGestor: false }); }} />
                </h1>
                ...
                <h1 className="text-3xl font-bold hidden lg:flex justify-between py-4">CACHAÇA GESTOR
                  ...
                  <p>
                    ...
                    <br></br>
                    <br></br>
                    Desde os tempos de estágio na empresa Cachaca Gestor, foi desenvolvido o projeto do sistema no
                    ...
                    <br></br>
                    <br></br>
                    Para gestão interna do sistema pelos colaboradores do Cachaca Gestor, coordenei a criação de um
                    ...
                    Também sou o responsável pelo processo de migração do sistema para o ReactJs com o uso do Typescript e NextJs e estilização com o Tailwind, atuando no
                  ...
                  <ul>
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <TbBrandReactNative size={28} className='hidden lg:flex my-2' /><strong>&nbsp;React Native:&nbsp;</strong>
                      </div>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <DiFirebase size={28} className='hidden lg:flex my-1' /><strong>&nbsp;Firebase:&nbsp;</strong>
                      </div>
                      <div className='flex w-full lg:w-[82%] items-center'>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <FaAngular size={28} className='hidden lg:flex my-1' /> <strong>&nbsp;Angular:&nbsp;</strong>
                      </div>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <FaReact size={28} className='hidden lg:flex my-1' /> <strong>&nbsp;React:&nbsp;</strong>
                      </div>
                      <div className='w-full flex w-full lg:w-[82%] items-center'>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <RiTailwindCssFill size={28} className='hidden lg:flex my-1' /> <strong>&nbsp;Tailwind:&nbsp;</strong>
                      </div>
                      <div className='w-full flex w-full lg:w-[82%] items-center'>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <SiCypress size={28} className='hidden lg:flex my-1' /> <strong>&nbsp;Cypress:&nbsp;</strong>
                      </div>
                      <div className='w-full flex w-full lg:w-[82%] items-center'>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <FaGitlab size={28} className='hidden lg:flex my-1' /> <strong>&nbsp;Cypress:&nbsp;</strong>
                      </div>
                      <div className='w-full flex w-full lg:w-[82%] items-center'>
                    ...
                    <li className='flex mb-1 border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <SiJasmine size={28} className='hidden lg:flex my-2' /> <strong>&nbsp;Jasmine:&nbsp;</strong>
                      </div>
                      <div className='w-full flex w-full lg:w-[82%] items-center'>
                  ...
                  <p>Atualmente estou neste projeto a {experienceTime('2020-03-01')} sendo uma excelente oportunidade para aplicar e aprimorar minhas
                    habilidades em desenvolvimento front-end, mobile e o básico do backend utilizando o NodeJS, que são ferramentas amplamente reconhecidas no mercado.
                  </p>
                  <br></br>
                  <p className='text-[10px]'>
                    <strong>Observações:</strong> Por motivo de direitos de licença, o projeto não pode ser usado para fins comerciais e seu código não pode ser compartilhado.
                  </p>
                </div>
              </div>
              <div className="grid lg:flex bg-gray-900 px-4 py-3 justify-center">
                <Button onClick={() => window.open('https://play.google.com/store/apps/details?id=com.app_cachacagestor&hl=pt&gl=US', '_blank')} title='ABRIR PLAYSTORE' icon='website' />
                <Button onClick={() => window.open('https://sistema.cachacagestor.com.br', '_blank')} title='ABRIR SITE' icon='website' />
                <Button onClick={() => window.open('https://www.instagram.com/cachacagestor/', '_blank')} title='ABRIR INSTAGRAM' icon='website' />
              </div>
            </div>
          </DialogPanel>
        </div>
