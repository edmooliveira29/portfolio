...
const DetailsNolascoModdas = ({ setShowDetails, showDetails }: Props) => {
  ...
  return (
    <Dialog open={open} onClose={() => { setOpen(false); setShowDetails({ ...showDetails, nolascoModdas: false }) }} className="relative z-10 lg:w-[80%]">
      <DialogBackdrop
        transition
            ...
            <div className="bg-gray-900">
              <div className='grid lg:flex justify-end bg-gray-900 text-white pt-4 pr-4 cursor-pointer'>
                <h1 className="text-2xl font-bold flex justify-between lg:hidden text-center px-4">NOLASCO MODDAS
                  <CgClose size={25} onClick={() => { setOpen(false); setShowDetails({ ...showDetails, nolascoModdas: false }); }} />
                </h1>
                <div className="w-full lg:w-1/2 flex items-center justify-center">
                  <div className="m-5">
                    <Image src={nolascoModdas.src} alt="Logo Nolasco Moddas" width={nolascoModdas.width} height={nolascoModdas.height} className='bg-cover' />
                  </div>
                </div>
                <div className="w-full lg:w-1/2 space-y-2 px-4">
                  ...
                  <br></br>
                  <p>
                    Além disso, foi realizada a <strong>configuração da plataforma</strong>, otimizando cada detalhe
                    para melhorar a experiência do usuário. Foi comprado um domínio no GoDaddy, realizando o <strong>direcionamento dos links</strong> o que garantiu
                  ...
                  <ul>
                    <li className='flex mb-3'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <Image src={logoNuvemShop.src} alt="Logo NuvemShop" width={logoNuvemShop.width} height={logoNuvemShop.height} className='h-auto' />
                  ...
                  <p>Tive a oportunidade de trabalhar neste projeto durante <strong>1 mês</strong>, sendo uma excelente oportunidade para aplicar e aprimorar minhas
                    habilidades em desenvolvimento nocode, utilizando o nuvemshop que é uma das plataformas mais utilizadas para o e-commerce.
                  </p>
                  <br></br>
                  <p className='text-[10px]'>
                    <strong>Observações:</strong> Por motivo de direitos de licença, o ambiente interno da plataforma não pode ser compartilhado.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex bg-gray-900 px-4 py-3 justify-center">
              <Button onClick={() => window.open('https://nolascomoddas.com.br', '_blank')} title='ABRIR SITE' icon='website' />
            </div>
          </DialogPanel>
        </div>
      </div>
