...
type Props = {
  setShowDetails: Dispatch<React.SetStateAction<{portfolio: boolean}>>
  showDetails: {
    portfolio: boolean
  }
}
const DetailsPortfolio = ({ setShowDetails, showDetails }: Props) => {
  ...
  return (
    <Dialog open={open}
      onClose={() => { setOpen(false); setShowDetails({ ...showDetails, portfolio: false }) }}
            ...
            <div className="bg-gray-900">
              <div className="lg:flex text-white text-sm">
                <h1 className="text-2xl font-bold flex lg:hidden justify-between p-4">
                  PORTFÓLIO - EDMO
                  <CgClose size={25}
                    onClick={() => { setOpen(false); setShowDetails({ ...showDetails, portfolio: false }) }} />
                </h1>
                ...
                <div className="w-full lg:w-1/2 p-5">
                  <h1 className="text-3xl font-bold hidden lg:flex my-3 justify-between">
                    PORTFÓLIO - EDMO
                    <CgClose size={25}
                      onClick={() => { setOpen(false); setShowDetails({ ...showDetails, portfolio: false }) }}
                      className="cursor-pointer" />
                  </h1>
                  <p>Este portfólio foi criado com as ferramentas mais atuais do mercado, para reunir
                    e destacar minha trajetória como desenvolvedor.
                  ...
                  <ul className="space-y-2 mt-2">
                    ...
                    <li><strong>Projetos:</strong> Projetos nos quais participei e/ou criei, com detalhes e resultados alcançados.</li>
                    <li><strong>Experiências:</strong> Histórico profissional com as principais experiências e funções desempenhadas.</li>
                    <li><strong>Formação:</strong> Detalhes sobre minha qualificações e cursos complementares.</li>
                    <li><strong>Contato:</strong> Meios de comunicação pelos quais poderão contatar-me.</li>
                  </ul>
                  <br></br>
                  <p>Com o uso do Tailwind, foi criado um projeto responsivo, capaz de se adaptar em diversos tamanhos de tela,
                  ...
                  <ul>
                    ...
                    <li className="flex mb-1 border-solid border-b border-gray-700">
                      ...
                      <div className="flex w-full lg:w-[82%] items-center">
                        ...
                        de paginas dinâmicas e facilitando no roteamento
                      </div>
                    </li>
