...
type Props = {
  setShowDetails: Dispatch<React.SetStateAction<{
...
const DetailsTCCPosGraduacao = ({ setShowDetails, showDetails }: Props) => {
  ...
  return (
    <Dialog open={open}
      onClose={() => { setOpen(false); setShowDetails({ ...showDetails, tccPosGraduacao: false }) }}
        ...
        <div className="lg:flex lg:justify-center m-4 text-center">
          ...
          >
              ...
              <div className="lg:flex text-white text-sm">
                ...
                <div className="flex w-full lg:w-1/2">
                  ...
                  <div className="flex justify-center items-center p-5 w-full">
                    <iframe className="w-full h-[300px] lg:h-[550px]"
                      src="https://www.youtube.com/embed/ELRQ65RPLvg"
                      title="Sistema gerenciador para MEIs  - Projeto Integrado da pós-graduação PUC-MG"
                ...
                <div className="w-full lg:w-1/2 p-2 text-[12px] ">
                  ...
                  <p>O backend foi utilizado a Arquitetura Limpa, proposta engenheiro de software Robert
                    C. Martin, conhecido como Uncle Bob. Esta arquitetura composta por um conjunto de princípios
                    que visam criar sistemas capazes de serem escaláveis e facilmente mantidos. Todo o sistema do backend
                     foi testado com o uso do Jest.
                  </p>
                  <br></br>
                  ...
                  <ul>
                    ...
                    <li className="flex my-1 border-solid border-b border-gray-700">
                      ...
                      <div className="flex w-full lg:w-[82%] items-center">
                        ...
                        para armazenar o sistema do backend e banco de dados.
                      </div>
                    </li>
                    <li className="flex my-1 border-solid border-b border-gray-700">
                      <div className="flex w-full lg:w-[18%] items-center">
                      ...
                      <div className="flex w-full lg:w-[82%] items-center">
                        ...
                        executar os testes, o build e o deploy dentro do Netlify.
                      </div>
                    </li>
                  </ul>
                  <br />
            ...
            <div className="grid lg:flex bg-gray-900 px-4 py-3 justify-center">
              <Button onClick={() => window.open("https://sistemagerenciador.netlify.app/", "_blank")}
                title="ABRIR SITE"
                icon="website" />
              <Button onClick={() => window.open("https://github.com/edmooliveira29/backend-system", "_blank")}
                title="ABRIR REPOSITÓRIO (BACKEND)"
                icon="github" />
              <Button onClick={() => window.open("https://github.com/edmooliveira29/frontend-system", "_blank")}
                title="ABRIR REPOSITÓRIO (FRONTEND)"
                icon="github" />
              <Button onClick={() =>
                window.open("https://drive.google.com/file/d/1m0bah0YqNEuoLuoO84eeM7RGdiBOZyJE/view?usp=sharing", "_blank")}
              title="ABRIR PROJETO"
              icon="drive" />
            </div>
          </DialogPanel>
