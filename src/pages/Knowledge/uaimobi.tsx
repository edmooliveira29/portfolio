...
const DetailsUaiMobi = ({ setShowDetails, showDetails }: Props) => {
  ...
  return (
    <Dialog open={open} onClose={() => { setOpen(false); setShowDetails({ ...showDetails, uaimobi: false }) }} className="relative z-10 lg:w-[90%]">
      <DialogBackdrop
        transition
        ...
        <div className="lg:flex lg:justify-center p-4 text-center ">
          ...
          >
            <div className="bg-gray-900 relative">
              <div className="lg:text-[12px] lg:flex text-white">
                <h1 className="text-2xl font-bold flex lg:hidden justify-between p-4 ">
                  UAI MOBI
                  <CgClose size={25} onClick={() => { setOpen(false); setShowDetails({ ...showDetails, uaimobi: false }); }} />
                </h1>
                <div className="w-full lg:w-1/2 flex items-center justify-center">
                  <div className="m-5 ">
                    <Image src={uaimobi.src} alt="Logo Nolasco Moddas" width={uaimobi.width} height={uaimobi.height} className='h-auto' />
                  </div>
                </div>
                <div className="w-full lg:w-1/2 p-5 relative">
                  ...
                  <ul>
                    <li className='flex my-2border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <FaReact size={28} className='hidden lg:flex my-2' /><strong>&nbsp;React:&nbsp;</strong>
                      </div>
                    ...
                    <li className='flex my-2border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <BsBootstrap size={28} className='hidden lg:flex my-2' /> <strong>&nbsp;Bootstrap:&nbsp;</strong>
                      </div>
                    ...
                    <li className='flex my-2border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center my-3'>
                        <svg xmlns="http://www.w3.org/2000/svg"
                          ...
                          viewBox="0 0 510.88 512" fill="currentColor"
                          className="w-6 h-6 hidden lg:flex">
                          <rect x="270.57" width="240.31" height="240.31" rx="24" fill="inherit"></rect>
                          <path d="M215.12 254.73V68.5a29.16 29.16 0 0 0-8.55-20.64 29.19 29.19 0 0 0-41.28 0L16.18 197a55.27 55.27 0 0 0 0 78.14l220.71 220.68a55.27 55.27 0 0 0 78.14 0l149.11-149.11a29.19 29.19 0 0 0 0-41.28l-1.14-1.12a29.16 29.16 0 0 0-20.64-8.55H256.15a41 41 0 0 1-41.03-41.03z" fill="inherit">
                          </path>
                        </svg> <strong>
                          &nbsp;EmailJS:&nbsp;</strong>
                      </div>
                    ...
                    <li className='flex my-2border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <SiReactrouter size={28} className='hidden lg:flex my-2' /> <strong>&nbsp;React Router DOM:&nbsp;</strong>
                      </div>
                      <div className='flex w-full lg:w-[82%] items-center'>
                    ...
                    <li className='flex my-2border-solid border-b border-gray-700'>
                      <div className='lg:flex w-full lg:w-[18%] items-center'>
                        <FaSass size={28} className='hidden lg:flex my-2' /><strong>&nbsp;Node-Sass:&nbsp;</strong>
                      </div>
                      <div className='flex w-full lg:w-[82%] items-center'>
            ...
            <div className="flex bg-gray-900 px-4 py-3 justify-center">
              <Button onClick={() => window.open('https://uaimobi.com.br', '_blank')} title='ABRIR SITE' icon='website' />
              <Button onClick={() => window.open('https://uaimobi.com.br', '_blank')} title='ABRIR REPOSITÓRIO' icon='github' />
            </div>
          </DialogPanel>
        </div>
      </div>
