        ...
        <div className="space-y-6 border-l-2 border-dashed">
            ...
            <div className='flex'>
              ...
              <div className="ml-6 w-1/3">
                ...
                <span className="mt-1 block text-sm text-white">
                  <a href="https://www.cachacha.com.br" target="_blank">Cachaça Gestor</a>
                </span>
              </div>
              <div className="ml-2 w-2/3">
                <p className="text-sm text-gray-500">
                  ...
                  Para o planejamento é utilizado a Metodologia Ágil com o método Scrum. Responsável também pela supervisão de estagiários.
                  <br></br>
                  <br></br>
          ...
          <div className="w-full">
            <div className='flex'>
              ...
              <div className="ml-2 w-2/3">
                <p className="text-sm text-gray-500">
                  Atuando sob a supervisão de <a className='font-[700]' href="https://www.linkedin.com/in/joaovqm/" target="_blank">João Vitor Mattos</a>,
                  fui instruído a fazer os testes unitários do backend em Jest. Realizei criei novas funcionalidades e fiz pequenas manutenções no Banco de Dados em MongoDB com TypeScript.
                  Também participei do desenvolvimento mobile utilizando React-Native com JavaScript e na execução de testes automatizados de ponta a ponta (e2e) com o AWS Device Farm.
                  <br></br>
                  <br></br>
                  Trabalhei em conjunto com o <a className='font-[700]' href="https://www.linkedin.com/in/italo-milagres/" target="_blank">Italo Milagres</a> na criação e manutenção
          ...
          <div className=" w-full">
            <div className='flex'>
              ...
              <div className="ml-2 w-2/3">
                <p className="text-sm text-gray-500">
                  Projeto sobre Robótica que aconteceu e acontece dentro da Universidade Federal de Ouro Preto no Campus de
                  Ciências Exatas e aplicadas. Neste projeto atuei como voluntário no subprojeto de construção e manutenção
                  de um robo conhecido como Segue linha. Nesta construção atuei na área de programação em Arduinos na linguagem C,
                  e construção do sistema eletrônico para o robo utilizando componentes eletrônicos como sensores.
                </p>
                <br></br>
                <p className="text-sm text-gray-500">
                  Participar do Locobots foi uma das melhores experiências que tive na Universidade. No Locobots, somos treinados a
                  pensar fora da caixinha, somos desafiados dia após dia nos relacionamentos interpessoais,
                  nas atividades, nas pesquisas e estruturas robóticas.
                </p>
                <a className='className="text-sm text-gray-500 font-[700]' href="https://www.instagram.com/locobots.ufop/" target="_blank">Clique aqui</a>
          ...
          <div className=" w-full">
            <div className='flex'>
              ...
              <div className="ml-2 w-2/3">
                <p className="text-sm text-gray-500">
                  Instalação de sistemas operacionais, instalação de softwares, montagem de computadores, reparo de hardware, manutenção em impressoras, dimensionamento rede e cabeamento e configuração
